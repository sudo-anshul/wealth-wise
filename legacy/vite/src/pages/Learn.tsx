...
const Learn = () => {
  ...
  const basicCourses = [
    {
      ...
      description:
        "Learn the fundamentals of the Indian stock market, key terminology, and how to get started.",
      level: "Beginner",
      duration: "2 hours",
      icon: Book,
      progress: 0,
    },
    {
      ...
      description:
        "Explore India's primary stock exchanges and how they function in the economy.",
      level: "Beginner",
      duration: "1.5 hours",
      icon: IndianRupee,
      progress: 0,
    },
    {
      ...
      description:
        "Learn how to analyze stocks using fundamental indicators and financial statements.",
      level: "Intermediate",
      duration: "3 hours",
      icon: TrendingUp,
      progress: 0,
  ...
  const advancedCourses = [
    ...
    },
    {
      ...
      description:
        "Learn advanced options strategies tailored for the Indian derivatives market.",
      level: "Advanced",
      duration: "5 hours",
      icon: Lightbulb,
      progress: 0,
  ...
  const games = [
    {
      ...
      description:
        "Practice trading in a risk-free environment with virtual money on virtual market data.",
      level: "All Levels",
      duration: "Unlimited",
      icon: Gamepad,
      badge: "Popular",
    },
    {
      ...
      description:
        "Compete with others to build the best performing portfolio over different time periods.",
      level: "Intermediate",
        ...
        <div className="container mx-auto flex items-center justify-between h-16">
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex space-x-6">
              ...
              <a href="/learn" className="text-primary font-medium">
                Learn
              </a>
              <a
                href="#"
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/60 mb-8">
              Comprehensive courses and interactive games designed to help you
              understand and navigate the Indian stock market with confidence.
            </p>
                    ...
                    <Card key={index} className="glass-card hover-scale">
                      <CardHeader className="pb-3">
                        <div className="flex justify-between items-start">
                          ...
                          <Badge
                            variant={
                              game.badge === "New" ? "default" : "secondary"
                            }
                            className="text-xs"
                          >
                            {game.badge}
                      ...
                      <CardFooter className="pt-2">
                        {game.title === "Market Simulator" ? (
                          <a
                            href="https://stock-market-simulator-puce.vercel.app/"
                            target="_blank"
            ...
            <TabsContent value="webinars" className="space-y-8">
              <div className="text-center py-16">
                ...
                <p className="text-white/60 max-w-md mx-auto">
                  Live webinars with market experts will be available soon.
        ...
        <div className="container mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/60 mb-4">
                  We've designed a personalized learning path to help you become
                  a confident investor in the Indian stock market.
                </p>
          ...
          <Card className="glass-card p-8">
            <CardHeader className="px-0 pt-0">
              ...
              <CardDescription className="text-white/60">
                Complete courses to earn certificates and track your learning
                journey
              </CardDescription>
            </CardHeader>
